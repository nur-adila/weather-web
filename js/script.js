...
document.body.style.backgroundImage = 'url(img/gambar1.jpg)'

searchButton.addEventListener('click', function() {

    fetch("https://api.openweathermap.org/data/2.5/weather?q="+inputKeyword.value+"&appid=13e2b53c7a333c9e20674785a6f5eedd&units=metric")
